...
# ![](http://latex.codecogs.com/gif.latex?\operatorname{vaR}=\mathrm{u}+\left(\frac{\beta}{\xi}\right)\left\{\left[\frac{\mathrm{N}}{\mathrm{n}}(1-confidencelevel)\right]^{-\xi}-1\right\})
